...
{if ("" != null) return mods;}
  ...
  final private JClassDeclaration classDeclaration(ArrayList<String> mods) throws ParseException {int line = 0;
    ...
    ArrayList<TypeName> qIdentifiers = new ArrayList<TypeName>();
    TypeName aIdentifier = null;
    try {
...
name = token.image;
      ...
      case IMPLEMENTS:{
        ...
        aIdentifier = qualifiedIdentifier();
qIdentifiers.add( aIdentifier );
        label_5:
        while (true) {
          switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
          case COMMA:{
...
{if ("" != null) return new JClassDeclaration(line, mods, name, superClass, null, classBody);}
  ...
  final private JInterfaceDeclaration interfaceDeclaration(ArrayList<String> mods) throws ParseException {int line = 0;
    ...
    if (mods.contains("final")) {
        reportParserError("Interface modifier can't be final.");
    }
    try {
...
{if ("" != null) return new JInterfaceDeclaration( line, mods, name, qIdentifiers,
                                                      interfaceBody );}
    throw new Error("Missing return statement in function");
}
...
name = token.image;
        ...
        case THROWS:{
          ...
          anException = qualifiedIdentifier();
...
{if ("" != null) return statement;}
  ...
  final private JStatement statement() throws ParseException {int line = 0;
    ...
    SwitchStatementGroup aSwitchStatementGroup = null;
    ArrayList<SwitchStatementGroup> switchBlockStmtGroup = new ArrayList<SwitchStatementGroup>();
    JBlock tryBlock = null;
    ArrayList<JFormalParameter> params = new ArrayList<JFormalParameter>();
    JFormalParameter aParam = null;
...
line = token.beginLine;
        ...
        body = statement();
statement =
                          new JForStatement( line, inits, expr, updates, body );
        break;
        }
      case SWITCH:{
...
line = token.beginLine;
        ...
        while (true) {
          ...
          aSwitchStatementGroup = switchBlockStatementGroup();
switchBlockStmtGroup.add(aSwitchStatementGroup);
        }
        jj_consume_token(RCURLY);
statement = new JSwitchStatement(line, test, switchBlockStmtGroup);
        break;
        }
      case TRY:{
...
statement = new JTryStatement( line, tryBlock, params, catchBlocks, finallyBlock);
          ...
          default:
            jj_la1[32] = jj_gen;
reportParserError( "Must have a finally block if no catches are present.");
          }
        }
        break;
        }
...
{if ("" != null) return statement;}
  ...
  final private SwitchStatementGroup switchBlockStatementGroup() throws ParseException {ArrayList<JExpression> switchLabels = new ArrayList<JExpression>();
        ArrayList<JStatement> blockstmts = new ArrayList<JStatement>();
        JExpression aExpression = null;
        JStatement aStatement = null;
    try {
      aExpression = switchLabel();
switchLabels.add(aExpression);
      label_15:
      while (true) {
        switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
        case CASE:
...
switchLabels.add(aExpression);
      ...
      while (true) {
        ...
        aStatement = blockStatement();
blockstmts.add(aStatement);
      }
    } catch (ParseException e) {
recoverFromError( new int[] { SEMI, EOF }, e );
    }
{if ("" != null) return new SwitchStatementGroup(switchLabels, blockstmts);}
    throw new Error("Missing return statement in function");
}
...
{if ("" != null) return expr;}
  ...
  final private ArrayList<JStatement> forInit() throws ParseException {int line = 0;
    ...
    JVariableDeclaration vDeclaration = null;
    try {
...
{if ("" != null) return init;}
  ...
  final private ArrayList<JStatement> forUpdate() throws ParseException {ArrayList<JStatement> updates = new ArrayList<JStatement>();
    JStatement aUpdate = null;
    try {
      aUpdate = statementExpression();
updates.add( aUpdate );
      label_18:
      while (true) {
        switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
...
{if ("" != null) return lhs;}
  ...
  final private JExpression conditionalExpression() throws ParseException {int line = 0;
    JExpression expr = null, assignExpr = null, conditionalExpr = null;
    try {
...
expr = new JConditionalExpression( line, expr, assignExpr,
                                                   conditionalExpr );
        break;
        }
      default:
  ...
  private boolean jj_3R_182()
 {
  ...
  static {
	...
	private static void jj_la1_init_0() {
	   jj_la1_0 = new int[] {0x0,0x40000000,0x41000,0x1000,0x1000,0x1000,0x1000000,0x0,0x20000000,0x0,0x1000000,0x423000,0x422000,0x0,0x0,0x422000,0x423000,0x0,0x0,0x422000,0x0,0x0,0x0,0x422000,0x1a6a6000,0x1a284000,0x2422000,0x2000000,0x2000000,0x108000,0x10000,0x4000000,0x4000000,0x2000000,0x1a284000,0x108000,0x108000,0x0,0x422000,0x0,0x0,0x422000,0x0,0x0,0x2000000,0x0,0x2000000,0x0,0x2000000,0x422000,0x422000,0x0,0x0,0x422000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x80000000,0x80000000,0x0,0x0,0x0,0x0,0x0,0x0,0x2000000,0x0,0x2000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x2000000,0x422000,0x0,0x0,0x0,0x2000000,};
	}
	private static void jj_la1_init_1() {
	   jj_la1_1 = new int[] {0x20,0x0,0x5c2,0x5c2,0x5c0,0x5c0,0x0,0x100000,0x0,0x100000,0x0,0x405c5,0x40005,0x100000,0x8000,0x5,0x405c5,0x100000,0x8000,0x40005,0x100000,0x8000,0x10800000,0x5,0x118b7a1d,0x118b7a18,0x101281d,0x1012818,0x1012818,0x0,0x0,0x0,0x0,0x1012818,0x118b7a18,0x0,0x0,0x100000,0x5,0x100000,0x100000,0x5,0x100000,0x0,0x1812818,0x100000,0x1812818,0x100000,0x1012818,0x5,0x5,0x400000,0x400000,0x5,0x40000000,0x40000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x20000000,0x20000000,0x0,0x0,0x0,0x0,0x1012818,0x0,0x1012818,0x600000,0x0,0x0,0x1000000,0x600000,0x1000000,0x1000000,0x1200000,0x1000000,0x1012818,0x5,0x800000,0x1000000,0x400000,0x10010,};
	}
	private static void jj_la1_init_2() {
	   jj_la1_2 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x2284820,0x2284820,0x2284820,0x2284820,0x2284820,0x0,0x0,0x0,0x0,0x2284820,0x2284820,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x8,0x2284820,0x0,0x2284820,0x0,0x2284820,0x0,0x0,0x0,0x0,0x0,0xa512008d,0xa512008d,0x8000000,0x8000,0x1000,0x400100,0x400100,0x42600,0x42600,0x10002,0x10002,0x2080000,0x2080000,0x50000040,0x50000040,0x2284820,0x204000,0x0,0x0,0x820,0x820,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
	}
	private static void jj_la1_init_3() {
	   jj_la1_3 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x4,0x4,0x0,0x0,0x4,0x4,0x0,0x0,0x4,0x0,0x0,0x0,0x4,0x3e4,0x3e4,0x3e4,0x3e4,0x3e4,0x0,0x0,0x0,0x0,0x3e4,0x3e4,0x0,0x0,0x0,0x4,0x0,0x0,0x4,0x0,0x0,0x3e4,0x0,0x3e4,0x0,0x3e4,0x0,0x0,0x0,0x0,0x4,0x2,0x2,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x3e4,0x0,0x3e4,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x3e4,0x4,0x0,0x0,0x0,0x3e0,};
	}
